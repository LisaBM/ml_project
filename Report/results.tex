...
\begin{table}[ht!]
	...
	\begin{tabular}{|l|l|l|l|l|l|l|l|l|l|l|l|} \hline
		...
		\multicolumn{1}{p{1.8cm}|}{One-vs-All uniquely classfied correctly linear} &
		\multicolumn{1}{p{1.8cm}|}{\vspace*{.25 cm}One-vs-All with barycenters linear} &
		\multicolumn{1}{p{1.8cm}|}{One-vs-All uniquely classfied correctly Gaussian} &
