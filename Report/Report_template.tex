\documentclass[12pt, a4paper, openany]{article} %, BCOR0mm scrbook
...
\usepackage{pdfpages}
%to make writing look like code, use \texttt{This is Courier font.} command
\usepackage{courier}
...
\begin{titlepage}
	...
	\HRule \\[0.8cm]
	{ \huge \bfseries Digit Recognition\\ with Support Vector Machines}\\[0.8cm] % Title of your document
	\HRule \\[1.5cm]
